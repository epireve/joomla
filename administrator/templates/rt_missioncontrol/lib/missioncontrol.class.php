...
//			require_once('menu'.DS.'rtsubmenu.class.php');
	...
	function displayUserInfo() {
		...
		$output .= '<span class="mc-button">'.$edit_link.JTEXT::_('MC_EDIT_BUTTON').'</a></span><br />';
        $output .= $messages . '<br />';
	...
	function displayStatus() {
		...
		if (!$disabled && $tools) 
			$output[] = array('<a href="#" id="ToolsToggle"><span class="select-active">'.JTEXT::_('MC_SYSTEM_TOOLS').'</span><span class="select-arrow">&#x25BE;</span></a>'.$tools, 'dropdown');
		else 
